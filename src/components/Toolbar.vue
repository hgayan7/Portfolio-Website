...
<nav>
    ...
    <v-toolbar flat dark fixed>
        ...
        <v-toolbar-items class="hidden-sm-and-down ">
            ...
            <v-btn flat color="grey" router to="/contact">Contact</v-btn>
        </v-toolbar-items>
    ...
    <v-navigation-drawer 
      dark
      app
      fixed  v-model="drawer" disable-resize-watcher width="200">
            <v-list app>
    ...
    data(){
        return{
            ...
            pages:[
                ...
                {icon:'golf_course',text:'Certifications',route:'/certifications'},
